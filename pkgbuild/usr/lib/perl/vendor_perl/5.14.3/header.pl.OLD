...
sub get_product_major_version() {
    my %version_settings = ();
    &readhash("/var/efw/version/settings", \%version_settings);
    my $product_major_version = $version_settings{'PRODUCT_MAJOR_VERSION'} ne "" ? $version_settings{'PRODUCT_MAJOR_VERSION'} : "";
...
sub showsubsubsection($) {
    ...
    showsubsection($selected->{'subMenu'}, 'menu-subtop'); # third level menu
}
...
END
    ...
    &showsubsubsection($menu); # third level menu
#    eval {
