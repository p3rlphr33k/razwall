...
if (!checkRenderer(type, logFactories)) {
    ...
    function firewallRenderer(text) {
		...
		linko.innerHTML = "<img src='/images/expand.png' alt='+' border='0' id='button_"+this.ms+"' onclick=\"showFullFirewallLog('"+this.ms+"');\" />";
