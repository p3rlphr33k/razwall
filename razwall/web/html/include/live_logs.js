...
var logTypes = new Array("squid","firewall","snort","dansguardian","commtouchweb","openvpn","system","smtp","clamav","panda","httpd");
...
function appendNode(node,log_list,reverse) {
	...
	inner_h = "<div id='"+id+"_h' class='header_"+type+"'>"+log_type_name+"</div>";
