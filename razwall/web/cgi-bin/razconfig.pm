...
sub _translatePath {
    ...
    my $real_path = $razBasePath . join('/', @path_parts);
    my $settings_file = pop(@path_parts);
    my $real_path_default = $razBasePath . join('/', @path_parts) . '/' . 'default/' . $settings_file;
    my $real_path_vendor = $razBasePath . join('/', @path_parts) . '/' . 'vendor/' . $settings_file;
