...
from endian.authentication_frontend.web.widgets.scope import ScopeEditor, ScopeGrid
...
class AllScopeController(ScopeAndProviderController):
    title = _("Authentication server mappings")

    editorWidget = ScopeEditor
    gridWidget = ScopeGrid
