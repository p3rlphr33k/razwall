...
def init(root):
    from endian.emi.controllers import registerController
    from endian.ipsec.web.controllers import IPsecController
    from endian.ipsec import commands # Init commands
    registerController(root, "ipsec", IPsecController())
