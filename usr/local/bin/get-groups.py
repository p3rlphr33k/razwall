...
def get_ldap_groups():
    ...
    searchFilter = "(objectClass=%s)" % config_values['LDAP_GROUP_OBJECT_CLASS']    # search for all groups
    groups = []
    ...
    groups.sort(lambda x, y: cmp(x.lower(),y.lower()))
    
    for group in groups:            # print all groups
        print group
